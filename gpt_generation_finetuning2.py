...
#generatereviews
def generate_reviews(model_dir, prompt="The spaghetti I ate yesterday was", num_reviews=5):
...
def main():
    ...
    pos_reviews = generate_reviews(pos_model_dir, prompt="The spaghetti I ate yesterday was", num_reviews=5)
    neg_reviews = generate_reviews(neg_model_dir, prompt="The spaghetti I ate yesterday was", num_reviews=5)
