...
def generate_reviews(model_dir, prompt="The movie was", num_reviews=5):
    ...
    with torch.no_grad():
        for _ in range(num_reviews):
            out = model.generate(input_ids=inputs, attention_mask=att_mask, max_length=50, min_length=10, temperature=0.81, do_sample=True, top_k=50, top_p=0.95, repetition_penalty=1.32)
